...
public class Users extends BaseEntity implements UserDetails {
    ...
    public Users(String name, String surname, String username, String password, String email, String picture, String tc, String gender, LocalDate birthDate, String phoneNumber) {
        this.name = name;
        this.surname = surname;
